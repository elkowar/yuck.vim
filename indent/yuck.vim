...
if exists("*searchpairpos")
	...
	if !exists('g:yuck_maxlines')
		let g:yuck_maxlines = 100
	endif

	if !exists('g:yuck_fuzzy_indent')
		let g:yuck_fuzzy_indent = 1
	endif

	if !exists('g:yuck_fuzzy_indent_patterns')
		let g:yuck_fuzzy_indent_patterns = ['^defwidget', '^defwindow', '^defvar', '^defpoll', '^include']
	endif

	if !exists('g:yuck_fuzzy_indent_blacklist')
		let g:yuck_fuzzy_indent_blacklist = []
	endif

	if !exists('g:yuck_special_indent_words')
		let g:yuck_special_indent_words = ''
	endif

	if !exists('g:yuck_align_multiline_strings')
		let g:yuck_align_multiline_strings = 0
	endif

	if !exists('g:yuck_align_subforms')
